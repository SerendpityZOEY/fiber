...
class FiberMapContent extends Component {
  ...
  render(){
    ...
    // Q: How did `fibers` get passed in as a property?
      //A: It get passed form FiberLayerGroup which contains geometryElements that has fibers
...
export default class FiberMap extends Component {
  ...
  render(){
    ...
    // Q: How did `setSelectedPosition` get passed in as a property?
      //A: it is imported from line 8, which is exported in SelectedPosition.js
    ...
    const leafletClickHandler = (event) => {
      ...
      // A: containerPoint: L.Point, lating: L.Lating, layerPoint: L.Point, originalEvent: MouseEvent,
          //target: NewClass
